...
use App\Form\LigneBonLivraisonType;
...
class BonLivraisonType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder->add('code', TextType::class, ['attr' => ['readonly' => true]])
                ->add('client',EntityType::class, ['attr'=>['required'=>true, 'class'=>'selectpicker','data-live-search'=>true,'title'=>'Chercher et sélectionner'],'class' => 'App\\Entity\\Client'])
                ->add('cin')
                ->add('nom')
                ->add('note')
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'App\Entity\BonLivraison'
        ));
    }
