 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\BonReceptionRepository")
 * @UniqueEntity("code")
...
class BonReception {
     ...
     * Set bonCommande
     *
     * @param \AppBundle\Entity\BonCommandeFrs $bonCommande
     *
     * @return BonCommandeFrs
     */
    public function setBonCommande(\AppBundle\Entity\BonCommandeFrs $bonCommande = null) {
     ...
     *
     * @return \AppBundle\Entity\LigneBonReception
     */
