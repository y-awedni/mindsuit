...
class LigneReglementBonLivraisonType extends AbstractType {
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\LigneReglementBonLivraison'
        ));
    }
    ...
    public function getBlockPrefix() {
        return 'appbundle_lignereglementbonlivraison';
    }
