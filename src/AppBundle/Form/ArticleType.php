...
class ArticleType extends AbstractType {
    ...
    private function addSousFamilleField(FormInterface $form, Famille $famille = null) {
        $form->add('sousfamille', EntityType::class, [
            ...
            'class' => 'AppBundle\Entity\Sousfamille',
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder->add('tva', EntityType::class, ['attr' => ['class' => 'selectpicker', 'data-live-search' => true, 'title' => 'Chercher et sélectionner'], 'class' => 'AppBundle:Tva', 'choice_label' => 'taux', 'choice_value' => 'taux']);
        $builder->add('note');
