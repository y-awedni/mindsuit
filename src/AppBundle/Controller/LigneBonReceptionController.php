 ...
 */
class LigneBonReceptionController extends Controller
{
    /**
    ...
    public function indexAction()
    {
        ...
        $ligneBonReceptions = $em->getRepository('AppBundle:LigneBonReception')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\LigneBonReceptionType', $ligneBonReception);
    ...
    {
        $deleteForm = $this->createDeleteForm($ligneBonReception);
        $editForm = $this->createForm('AppBundle\Form\LigneBonReceptionType', $ligneBonReception);
