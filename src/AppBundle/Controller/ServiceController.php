...
class ServiceController extends Controller {
    ...
    public function getTitreByParameteres($em, $request) {
        ...
        if ($request->query->get('article')) {
            $i > 0 ? $chaine .= ',' : $i++;
            $article = $em->getRepository('AppBundle:Article')->findOneById($request->query->get('article'));
    ...
    public function getQbByParametres($em, $request) {
        $qb = $em->getRepository('AppBundle:Stock')->createQueryBuilder('a');
    ...
    public function indexAction(Request $request) {
        ...
        $articles = $em->getRepository('AppBundle:Article')->findAllServicesAndProduitsNonStockables();
