...
class BonCommandeFrsController extends Controller {
    ...
    public function getQbByParametres($em, $request) {
        $qb = $em->getRepository('AppBundle:BonCommandeFrs')->createQueryBuilder('a');
    ...
    public function newAction(Request $request) {
        ...
        $form = $this->createForm('AppBundle\Form\BonCommandeFrsType', $bonCommandeFrs);
    ...
    public function editAction(Request $request, BonCommandeFrs $bonCommandeFrs) {
        ...
        $editForm = $this->createForm('AppBundle\Form\BonCommandeFrsType', $bonCommandeFrs);
