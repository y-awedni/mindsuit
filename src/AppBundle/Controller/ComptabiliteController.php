    ...
    public function indexAction(Request $request) {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($form->get('saveDepences')->isClicked()) {
                $typeMvt = 'depenses';
                $mouvements = $em->getRepository('AppBundle:Mouvement')->findAllDepencesByInterval($dateDebut, $dateFin);
                $autresMvts = $em->getRepository('AppBundle:BonReception')->findAllDepencesByInterval($dateDebut, $dateFin);
            } else {
                $typeMvt = 'revenus';
                $mouvements = $em->getRepository('AppBundle:Mouvement')->findAllRevenusByInterval($dateDebut, $dateFin);
                $autresMvts = $em->getRepository('AppBundle:Facture')->findAllRevenusByInterval($dateDebut, $dateFin);
            }
