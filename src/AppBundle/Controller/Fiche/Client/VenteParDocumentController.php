 ...
 */
class VenteParDocumentController extends Controller {

    public function getTitreVenteParDocumentByParameteres($em, $request) {
        $chaine = '(';
        $i = 0;
    ...
    public function getVenteParDocumentQbByParametres($em, $request, $client) {
    ...
    /**
     * Liste des ventes par document
     *
     * @Route("/{id}", name="fiche_client_vente_document")
     * @Method("GET")
     */
    public function venteParDocumentAction(Request $request, Client $client, $offset = 0, $limit = 10) {
        ...
        return $this->render('fiche/client/venteParDocument.html.twig', array(
                    'pagination' => $items,
     ...
     *
     * @Route("/export/xls", name="fiche_client_vente_document_xls")
     * @Method("GET")
     */
    public function venteParDocumentExportXlsAction(Request $request) {
        ...
        $sheet->setCellValue('A1', 'Liste des ventes par document de client ' . $client . ' ( ' . count($entities) . ' résultat(s) )');
