...
class BonReceptionController extends Controller {
    ...
    public function getQbByParametres($em, $request) {
        $qb = $em->getRepository('AppBundle:BonReception')->createQueryBuilder('a');
    ...
    public function indexAction(Request $request) {
        ...
        $boncommandes = $em->getRepository('AppBundle:BonCommandeFrs')->findAll();
    ...
    public function exportXlsAction(Request $request) {
        ...
        $phpExcelObject->getActiveSheet()->getColumnDimensionByColumn('C')->setAutoSize(false);
        $i = 5;
    ...
    public function bonreceptionBoncommandeNewAction(Request $request) {
        ...
        $bonCommande = $em->getRepository('AppBundle:BonCommandeFrs')->findOneById($bonCommandeId);
        ...
        foreach ($bonCommande->getLigneBonCommandeFrss() as $ligneBc) {
            $ligneBr = new \AppBundle\Entity\LigneBonReception();
        ...
        $form = $this->createForm('AppBundle\Form\BonReceptionType', $bonReception);
    ...
    public function editAction(Request $request, BonReception $bonReception) {
        ...
        $editForm = $this->createForm('AppBundle\Form\BonReceptionType', $bonReception);
    ...
    public function reglementsAction(Request $request, BonReception $bonreception) {
        ...
        $form = $this->createForm('AppBundle\Form\LigneReglementBonReceptionType', $ligneReglement);
        $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {
        ...
        $ligneReglements = $em->getRepository('AppBundle:LigneReglementBonReception')->findByBonReception($bonreception);
    ...
    public function reglementDeleteAction($id, $idLigneReglement) {
        $em = $this->getDoctrine()->getManager();
        $ligneReglement = $em->getRepository('AppBundle:LigneReglementBonReception')->find($idLigneReglement);
