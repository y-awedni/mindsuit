...
class LigneDevisController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ligneDevis = $em->getRepository('AppBundle:LigneDevis')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\LigneDevisType', $ligneDevi);
    ...
    {
        $deleteForm = $this->createDeleteForm($ligneDevi);
        $editForm = $this->createForm('AppBundle\Form\LigneDevisType', $ligneDevi);
