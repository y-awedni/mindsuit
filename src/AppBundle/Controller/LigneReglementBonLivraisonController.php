 ...
 */
class LigneReglementBonLivraisonController extends Controller
{
    /**
     * Lists all ligneReglementBonLivraison entities.
     *
     * @Route("/", name="lignereglementbonlivraison_index")
     * @Method("GET")
     */
    public function indexAction()
    {
        ...
        $ligneReglementBonLivraisons = $em->getRepository('AppBundle:LigneReglementBonLivraison')->findAll();
     ...
     *
     * @Route("/new", name="lignereglementbonlivraison_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        $ligneReglementBonLivraison = new Lignereglementbonlivraison();
        $form = $this->createForm('AppBundle\Form\LigneReglementBonLivraisonType', $ligneReglementBonLivraison);
     ...
     *
     * @Route("/{id}", name="lignereglementbonlivraison_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="lignereglementbonlivraison_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, LigneReglementBonLivraison $ligneReglementBonLivraison)
    {
        $deleteForm = $this->createDeleteForm($ligneReglementBonLivraison);
        $editForm = $this->createForm('AppBundle\Form\LigneReglementBonLivraisonType', $ligneReglementBonLivraison);
     ...
     *
     * @Route("/{id}", name="lignereglementbonlivraison_delete")
     * @Method("DELETE")
     */
