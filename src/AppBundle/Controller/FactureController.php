...
class FactureController extends Controller {
    ...
    public function editAction(Request $request, Facture $facture) {
        ...
        $editForm = $this->createForm('AppBundle\Form\FactureType', $facture, array(
    ...
    public function reglementsAction(Request $request, Facture $facture) {
        ...
        $totalAvoir = $em->getRepository('AppBundle:Facture')->findAllTotalAvoirRemboursement($facture->getId());
        //$totalAvoir=0;
        $ligneReglements = $em->getRepository('AppBundle:LigneReglement')->findByFacture($facture);
    ...
    public function reglementDeleteAction($id, $idLigneReglement) {
        $em = $this->getDoctrine()->getManager();
        $ligneReglement = $em->getRepository('AppBundle:LigneReglement')->find($idLigneReglement);
