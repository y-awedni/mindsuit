...
class LigneReglementBonReceptionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ligneReglementBonReceptions = $em->getRepository('AppBundle:LigneReglementBonReception')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\LigneReglementBonReceptionType', $ligneReglementBonReception);
    ...
    {
        $deleteForm = $this->createDeleteForm($ligneReglementBonReception);
        $editForm = $this->createForm('AppBundle\Form\LigneReglementBonReceptionType', $ligneReglementBonReception);
