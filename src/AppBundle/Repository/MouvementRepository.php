...
class MouvementRepository extends EntityRepository {
    ...
    public function findAllDepencesByInterval($d1, $d2) {
        ...
        return $this->getEntityManager()
                        ->createQuery(
                                "SELECT m FROM AppBundle:Mouvement m WHERE m.mouvement LIKE 'depense' AND m.dateCreation BETWEEN '" . $dateDebut . "' AND '" . $dateFin . "' ORDER BY m.dateCreation ASC"
                        )
                        ->getResult();
    }
    ...
    public function findAllRevenusByInterval($d1, $d2) {
        ...
        return $this->getEntityManager()
                        ->createQuery(
                                "SELECT m FROM AppBundle:Mouvement m WHERE m.mouvement LIKE 'revenu' AND m.dateCreation BETWEEN '" . $dateDebut . "' AND '" . $dateFin . "' ORDER BY m.dateCreation ASC"
                        )
                        ->getResult();
    }
    ...
    public function findAllCountChequeEntre($from, $towards) {
        ...
        return $this->getEntityManager()
                        ->createQuery(
                                "SELECT count(m.id) FROM AppBundle:Mouvement m "
