 ...
 * Banque
 *
 * @ORM\Table(name="banque", indexes={@ORM\Index(name="created_user_id", columns={"created_user_id"}), @ORM\Index(name="created_user_id_2", columns={"created_user_id"}), @ORM\Index(name="updated_user_id", columns={"updated_user_id"})})
 * @ORM\Entity
 * 
